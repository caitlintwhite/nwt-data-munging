...
#option to make plots or not, otherwise must run in interactive mode
...
sdlcr_qa <- read_csv(paste0(datpath, "prep_data/qa_sdlcr_temp_thru_2019.csv"), na = na_vals, trim_ws = T) %>% as.data.frame()
# sdl chart
...
# write out
write_csv(mastertemp, paste0(datpath, "prep_data/predict_sdl_cralltemp_1982-2019.csv"))
