...
masterPCA <- rbind(jennings_subset_PCA, nwt_subset_PCA, nwt_allyrs_PCA, nwt_raw_PCA, cr1000_allyrs_PCA)
...
masterloadings$source <- factor(masterloadings$source, levels = c("Raw + CTW infill 2010-2018","NSF renewal + CTW infill 2015-2018",
                                                                  "CR1000 NSF predicted", "NWT NSF renewal", "Jennings et al. 2018"))
...
sploadings_fig <- ggplot(masterloadings, aes(PC1, PC2)) +
  ...
  #coord_equal() +
  #scale_x_continuous(breaks = seq(1980, 2020, 5)) +
  labs(title = "PCA 'species' loadings comparison:\nRaw/CTW 1982-2018, NSF/CTW 1982-2018, CR1000 predicted 1982-2018, NSF 1991-2013, Jennings 1991-2013") +
...
yrloadings_fig <- masterPCA %>%
  ...
  #coord_equal() +
  #scale_x_continuous(breaks = seq(1980, 2020, 5)) +
  labs(title = "PCA year loadings comparison: Raw/CTW 1982-2018, NSF/CTW 1982-2018, CR1000 predicted 1982-2018, NSF 1991-2013, Jennings 1991-2013",
