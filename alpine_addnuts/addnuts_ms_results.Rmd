...
```{r plot sdl nmds}
ggplot(sdlplotmds, aes(MDS1, MDS2)) +
  geom_point(data = sdlsppmds, aes(MDS1, MDS2, shape = simple_lifeform), alpha = 0.5) +
  #geom_polygon(data = sdlhulls, aes(MDS1, MDS2, fill = trt, col = trt), alpha = 0.5) +
  geom_polygon(data=sdlells, aes(x=NMDS1, y=NMDS2,fill=trt), alpha = 0.5) +
