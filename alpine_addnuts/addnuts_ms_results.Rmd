...
kable(rename_all(table_nn17spp, function(x)gsub("_", " ", x)) %>%
        rename(lifeform = `simple lifeform2`,
               species = `simple name`), caption = "Species with mean abundance >= 2%, n = 4 per treatment group")
```
